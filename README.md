...
- **2.** [Report](#2-report)
   ...
   - **2.2** [Process](#22-process)
     - **2.2.1** [First steps and general idea](#221-first-steps-and-general-idea)
     - **2.2.2** [Prompt Development](#222-prompt-development)
     - **2.2.3** [Project Timeline (after video collection)](#223-project-timeline-after-video-collection)
   - **2.3** [Results](#23-results)
   - **2.4** [Conclusion & Outlook](#24-conclusion--outlook)
- **3.** [Pipeline](#3-pipeline)
   - **3.1** [Features](#31-features)
   - **3.2** [Project Structure](#32-project-structure)
- **4.** [Usage](#4-usage)
   - **4.1** [Setup Instructions](#41-setup-instructions)
     - **4.1.1** [Clone the Repository](#411-clone-the-repository)
     - **4.1.2** [Set up .env file](#412-set-up-env-file)
   - **4.2** [Running the scripts](#42-running-the-scripts)
- **5.** [Using another LLM](#5-using-another-llm)
   - **5.1** [Replace the scene summarization model](#51-replace-the-scene-summarization-model-vision-capable)
   - **5.2** [Replace the rating-generation model (text-only)](#52-replace-the-rating-generation-model-text-only)
   - **5.3** [Environment variables and keys](#53-environment-variables-and-keys)
   - **5.4** [Constraints imposed by the current design](#54-constraints-imposed-by-the-current-design)
...
In parallel, several studies have explored the capabilities and limitations of general-purpose VLMs such as GPT-4V when applied to traffic understanding (Zhou, Knoll, 2024). Qualitative evaluations show that these models can correctly interpret many standard traffic situations and reason about agent behavior, yet consistently fail in more complex, safety-critical cases such as vehicle collisions, fires, or multi-vehicle accidents. These failures are often linked to weaknesses in temporal integration, spatial grounding, and causal consistency across frames. Work on crash localization further suggests that even specialized video–language models struggle to detect brief, rare events like collisions without architectures explicitly designed for fine-grained temporal modeling, underscoring a fundamental limitation of current approaches (Shihab, Akter, Sharma, 2025).
...
### 2.2.1 First steps and general idea
...
### 2.2.3 Project Timeline (after video collection)

---

#### Milestone 1: Initial Setup & Pipeline Construction
...
#### Milestone 2: Initial Summary Testing & Model Adjustments
...
#### Milestone 3: Rating Generation Testing & Evaluation
...
#### Milestone 4: Model Update & Full Dataset Investigation
...
Tan, Z., Zhang, T., Liu, X., & Zhao, H. (2024). Large language models for data annotation and synthesis. In Proceedings of EMNLP 2024 (pp. 731–748). ACL. https://aclanthology.org/2024.emnlp-main.54
...
Wu, K., Zhang, Y., Li, H., & Zhao, X. (2024). Large multi-modal foundation model for traffic accident analysis (AccidentGPT). In Proceedings of the 19th International Conference on Computer Vision Theory and Applications (VISAPP 2024). SCITEPRESS. https://www.scitepress.org/Papers/2024/124221/124221.pdf

X. Zhou and A. C. Knoll, “GPT-4V as Traffic Assistant: An In-depth Look at Vision Language Model on Complex Traffic Events,” arXiv preprint, arXiv:2402.02205v3, Feb. 2024.
